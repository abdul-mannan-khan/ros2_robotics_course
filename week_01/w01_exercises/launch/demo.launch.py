#!/usr/bin/env python3
"""Demo launch: bag playback + 3 solution nodes + RViz2 for week 01."""
import os
...
def generate_launch_description():
    ...
    rviz_config = os.path.join(src_dir, 'w01_exercises', 'config', 'rviz_config.rviz')
    ...
    return LaunchDescription([
        ...
        TimerAction(period=2.0, actions=[
            Node(
                package='week_01_lidar_processing',
