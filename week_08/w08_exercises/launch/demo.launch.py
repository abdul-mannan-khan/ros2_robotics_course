#!/usr/bin/env python3
"""Demo launch: bag playback + 3 solution nodes + RViz2 for week 08."""
import os
...
def generate_launch_description():
    ...
    bag_dir = os.path.join(src_dir, 'w08_exercises', 'bag_data', 'synthetic_3d_env')
    config = os.path.join(src_dir, 'w08_exercises', 'config', 'params.yaml')
    rviz_config = os.path.join(src_dir, 'w08_exercises', 'config', 'rviz_config.rviz')
    ...
    return LaunchDescription([
        ...
        TimerAction(period=2.0, actions=[
            Node(
                package='week_08_3d_path_planning',
