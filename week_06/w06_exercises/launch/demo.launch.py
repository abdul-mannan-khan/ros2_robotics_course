#!/usr/bin/env python3
"""Demo launch: bag playback + 3 solution nodes + RViz2 for week 06."""
import os
...
def generate_launch_description():
    ...
    bag_dir = os.path.join(src_dir, 'w06_exercises', 'bag_data', 'synthetic_quadrotor')
    config = os.path.join(src_dir, 'w06_exercises', 'config', 'params.yaml')
    rviz_config = os.path.join(src_dir, 'w06_exercises', 'config', 'rviz_config.rviz')
    ...
    return LaunchDescription([
        ...
        TimerAction(period=2.0, actions=[
            Node(
                package='week_06_quadrotor_dynamics',
