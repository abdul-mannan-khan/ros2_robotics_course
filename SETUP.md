...
```bash
cd ~/auto_ws/src/ros2_robotics_course/week_01/w01_exercises
...
ros2 bag play ~/auto_ws/src/ros2_robotics_course/week_01/w01_exercises/bags/lidar_data
```
...
```bash
rviz2 -d ~/auto_ws/src/ros2_robotics_course/week_01/w01_exercises/config/rviz_config.rviz
```
...
# week_01 -> ros2_robotics_course/week_01
# week_02 -> ros2_robotics_course/week_02
...
```bash
chmod +x ~/auto_ws/src/ros2_robotics_course/week_*/w*_exercises/scripts/*.py
```
