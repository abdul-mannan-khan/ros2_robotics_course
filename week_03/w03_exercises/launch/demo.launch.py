#!/usr/bin/env python3
"""Demo launch: bag playback + 3 solution nodes + RViz2 for week 03."""
import os
...
def generate_launch_description():
    ...
    bag_dir = os.path.join(src_dir, 'w03_exercises', 'bag_data', 'synthetic_turtlebot')
    config = os.path.join(src_dir, 'w03_exercises', 'config', 'params.yaml')
    rviz_config = os.path.join(src_dir, 'w03_exercises', 'config', 'rviz_config.rviz')
    ...
    return LaunchDescription([
        ...
        TimerAction(period=2.0, actions=[
            Node(
                package='week_03_ros2_fundamentals',
