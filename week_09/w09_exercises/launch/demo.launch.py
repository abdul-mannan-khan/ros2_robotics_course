#!/usr/bin/env python3
"""Demo launch: bag playback + 3 solution nodes + RViz2 for week 09."""
import os
...
def generate_launch_description():
    ...
    bag_dir = os.path.join(src_dir, 'w09_exercises', 'bag_data', 'synthetic_ego_planner')
    config = os.path.join(src_dir, 'w09_exercises', 'config', 'params.yaml')
    rviz_config = os.path.join(src_dir, 'w09_exercises', 'config', 'rviz_config.rviz')
