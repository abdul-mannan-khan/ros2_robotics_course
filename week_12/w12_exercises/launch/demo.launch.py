#!/usr/bin/env python3
"""Demo launch: bag playback + 3 solution nodes + RViz2 for week 12."""
import os
...
def generate_launch_description():
    ...
    bag_dir = os.path.join(src_dir, 'w12_exercises', 'bag_data', 'synthetic_capstone')
    config = os.path.join(src_dir, 'w12_exercises', 'config', 'params.yaml')
    rviz_config = os.path.join(src_dir, 'w12_exercises', 'config', 'rviz_config.rviz')
